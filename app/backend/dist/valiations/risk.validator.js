...
const riskSchema = Joi.object({
    ...
    functional: Joi.number().default(0),
    ...
    restaurent_bar_or_club: Joi.number().default(0),
    manufacturing: Joi.number().default(0),
    mechanical_repair: Joi.number().default(0),
...
const RiskRequestValidator = (0, JoiValidator_1.default)(riskSchema);
exports.default = RiskRequestValidator;
//# sourceMappingURL=risk.validator.js.map